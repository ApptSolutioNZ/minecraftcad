...
public class TilemCAD extends TileEntity {
    ...
    public void readFromNBT(NBTTagCompound nbtTagCompound) {
        ...
        // orientation =
        // ForgeDirection.getOrientation(nbtTagCompound.getByte(Strings.NBT_TE_DIRECTION_KEY));
        // }
        //
    ...
    public void writeToNBT(NBTTagCompound nbtTagCompound) {
        ...
        //
        // nbtTagCompound.setByte(Strings.NBT_TE_DIRECTION_KEY, (byte)
        // orientation.ordinal());
    ...
    public String toString() {
        ...
        stringBuilder
                .append(String
                        .format("TilemCAD Data - xCoord: %d, yCoord: %d, zCoord: %d, customName: '%s', orientation: %s, state: %d\n",
